...
class SeoCheckerScreen extends StatelessWidget {
  final String text;
  SeoCheckerScreen({Key key, @required this.text}) : super(key: key);

  // This widget is the root of your application.
  @override
  Widget build(BuildContext context) {
    return _SeoCheckerScreen();
  }
}

class _SeoCheckerScreen extends StatefulWidget {
  _SeoCheckerScreen({Key key}) : super(key: key);
  @override
  _SeoCheckerScreenState createState() => _SeoCheckerScreenState();
}

class _SeoCheckerScreenState extends State<_SeoCheckerScreen> {
  String selectedItem;
