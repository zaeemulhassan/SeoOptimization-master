...
import 'package:seooptimization/Admin/screens/update_profile_page.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:seooptimization/Admin/screens/change_password_page.dart';
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: CircleAvatar(
                ...
                child: CircleAvatar(
                  radius: 65,
                  backgroundImage: AssetImage("assets/images/employer_green.png"),
                ),
              ),
            ),
            Container(
    ...
    final Favourite = Container(
        ...
        child: InkWell(
          onTap: () {
            ...
            //   MaterialPageRoute(
            //     builder: (context) => FavouriteScreen(text:"Favourites"),
            //   ),
            // );
          },
          child: Card(
